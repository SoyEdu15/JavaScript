...
// Devuelve una colección de elementos que coincidan con el parámetro
...
// También se puede recorrer la lista
...
let textDom = `Con DOM, podemos acceder y manipular fácilmente etiquetas, ID, clases, atributos o elementos de HTML utilizando comandos o métodos proporcionados por el objeto del documento.`
...
$domArbol.innerHTML = textArbol; // Propiedad que permite reemplazar el contenido que tenga la etiqueta o selector por contenido HTML.

// También existe la propiedad outerHTML que permite remplazar el contenido y la etiqueta por el contenido HTML que se le indique.
...
$img.setAttribute("src", "https://placeimg.com/200/200/animals"); // Método que accede a los Atributos de los elementos
...
// Método que inserta contenido HTML dependiendo una posición
$nuevaImagen.insertAdjacentHTML("afterbegin", $contenidoHTML);
// Método que inserta un elemento dependiendo una posición
$selectorImagenes.insertAdjacentElement("beforeend", $nuevaImagen);
// Método que inserta texto dependiendo una posición
